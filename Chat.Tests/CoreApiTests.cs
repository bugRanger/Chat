namespace Chat.Tests
{
    ...
    public partial class CoreApiTests
    {
        ...
        public void PrivateMessageNotLogginTest()
        {
            ...
            _expectedEvent.Add(new TestEvent(_remotes[0], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":5,\"Reason\":\"User is not logged in\"}}")));
        ...
        public void PrivateMessageNotExistsTargetTest()
        {
            ...
            var request = PacketFactory.Pack("{\"Id\":1,\"Type\":\"message\",\"Payload\":{\"Source\":\"User1\",\"Target\":\"User2\",\"Message\":\"Hi!\"}}");
            _expectedEvent.Add(new TestEvent(_remotes[0], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":2,\"Reason\":\"Target not found\"}}")));
        ...
        public void PrivateMessageTest() 
        {
            ...
            var request = PacketFactory.Pack("{\"Id\":1,\"Type\":\"message\",\"Payload\":{\"Source\":\"User1\",\"Target\":\"User2\",\"Message\":\"Hi!\"}}");
            _expectedEvent.Add(new TestEvent(_remotes[0], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":0,\"Reason\":\"\"}}")));
        ...
        public void UnauthorizationNotLogginTest()
        {
            ...
            // Assert
            Assert.AreEqual(0, _auth.GetUsers().Length);
        ...
        public void ReAuthorizationWithRenameTest()
        {
            ...
            // Assert
            Assert.AreEqual(1, _auth.GetUsers().Length);
        ...
        public void DuplicateAuthorizationAnotherAddressTest()
        {
            ...
            _expectedEvent.Add(new TestEvent(_remotes[1], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":3,\"Reason\":\"User exists\"}}")));
        ...
        public void DuplicateAuthorizationTest()
        {
            ...
            var request = PacketFactory.Pack("{\"Id\":1,\"Type\":\"auth\",\"Payload\":{\"User\":\"User1\"}}");
            _expectedEvent.Add(new TestEvent(_remotes[0], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":3,\"Reason\":\"User exists\"}}")));
        ...
        public void AuthorizationTest()
        {
            ...
            _expectedEvent.Add(new TestEvent(_remotes[_remotes.Count - 1], PacketFactory.Pack("{\"Id\":1,\"Type\":\"result\",\"Payload\":{\"Status\":0,\"Reason\":\"\"}}")));
            _expectedEvent.Add(new TestEvent(_remotes[_remotes.Count - 1], PacketFactory.Pack("{\"Id\":0,\"Type\":\"users\",\"Payload\":{\"Users\":[" + users + "]}}")));
        ...
        public void ConnectionTest() 
        {
            ...
            // Act
            _networkMoq.Raise(s => s.ConnectionAccepted += null, _remotes[_remotes.Count - 1]);

            // Assert
            Assert.IsFalse(_auth.TryGet(_remotes[_remotes.Count - 1], out _));
            CollectionAssert.AreEqual(_expectedEvent, _actualEvent);
        }
    }
}
